...
CREATE TABLE IF NOT EXISTS "products" (
	...
	CONSTRAINT "products_owner_user_id_name_unique" UNIQUE("owner_user_id","name")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "variants" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "variants_owner_user_id_sku_unique" UNIQUE("owner_user_id","sku"),
	CONSTRAINT "variants_owner_user_id_product_id_variant_key_unique" UNIQUE("owner_user_id","product_id","variant_key")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "variant_option_values" (
	...
	"owner_user_id" uuid NOT NULL,
	CONSTRAINT "variant_option_values_variant_attribute_unique" UNIQUE("variant_id","attribute_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "variant_prices" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "variant_prices_variant_id_customer_type_unique" UNIQUE("variant_id","customer_type")
);
--> statement-breakpoint
DO $$ BEGIN
